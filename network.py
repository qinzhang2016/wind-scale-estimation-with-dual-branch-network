...
def resnet18(pretrained=False, channel= 20, num_classes= 11, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], nb_classes=num_classes, channel=channel, **kwargs)
    if pretrained:
...
if __name__ == '__main__':
    model = resnet18(pretrained= True, channel=3, num_classes=11)
    print(model)
